<template>
  <v-row>
    <v-col cols="12" class="mt-0 pt-0">
      ...
      <div class="mb-3">
        <h4 class="my-3 h4 font-weight-bold">{{ state.pool.name }}</h4>
  ...
  <div class="d-flex my-5">
    <p class="h6 font-weight-bold">Overview</p>
    <v-spacer />
  ...
  <v-row>
    <v-col cols="12" md="6">
      <div class="d-flex my-3">
        <p class="h6 font-weight-bold">Depositors</p>
        <v-spacer />
    ...
    <v-col cols="12" md="6">
      <div class="d-flex my-3">
        <p class="h6 font-weight-bold">Transactions</p>
        <v-spacer />
...
export default {
  components: { PoolDepositModal, Depositors, Balance, PoolWithdrawalModal, Transactions },
  setup() {
